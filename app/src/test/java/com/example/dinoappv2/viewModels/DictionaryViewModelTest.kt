...
class DictionaryViewModelTest {
    ...
    fun filterDictionaryData_searchNone_returnAll() {
        ...
        assertThat(dictionaryViewModel.allWords.getOrAwaitValue(), `is`(wordList()))
    }
    ...
    fun filterDictionaryData_searchDne_returnEmptyList() {
        ...
        assertThat(dictionaryViewModel.allWords.getOrAwaitValue(), `is`(emptyList()))
    }
    ...
    fun filterDictionaryData_searchLowerA_returnAbilityAttract() {
        ...
        assertThat(dictionaryViewModel.allWords.getOrAwaitValue(), `is`(words))
    }
    ...
    fun filterDictionaryData_searchWorldWarII_returnWorldWarII() {
        ...
        assertThat(dictionaryViewModel.allWords.getOrAwaitValue(), `is`(word))
    }
}
